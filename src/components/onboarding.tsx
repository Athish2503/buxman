...
const SLIDES = [
  {
    ...
    sub: 'Log receipts, categorise spending, and never miss a reimbursement claim — all in one tap.',
  ...
  },
  {
    ...
    sub: 'Beautiful charts and budget tracking give you complete clarity on where your money flows.',
    tag: 'INSIGHTS',
  },
  {
    icon: Shield,
  ...
  },
  {
    ...
    sub: 'Generate a polished PDF invoice or CSV for any date range with a single tap.',
    tag: 'PRODUCTIVITY',
  },
];
